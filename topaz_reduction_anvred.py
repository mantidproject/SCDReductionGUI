...
# File: ReduceSCD_TOPAZ.py Ver.1.0
#
...
while True:
    ...
    if dn !=58:
        ...
        fsq = fsq * scaleFactor * cmonx
        sigfsq = sigfsq * scaleFactor * cmonx
...
cif_output.write('# CIF for TOPAZ neutron time of flight Laue Experiment\n'
    ...
    + '_diffrn_source                       "The ORNL Spallation Neutron Scource"\n'
